...
public class Main {
    public static void main(String[] args) {
        ...
        /* Making Map of films that jaak wants to rent.
        ...
        /* Jaak renting the movies. First argument is the customers object
            and second argument is Map of movies that customer wants to rent.
        ...
        System.out.println("\nAll the movies are not in store:");
        ...
        /* Making Map of films that Jaak wants to return.
        ...
        System.out.println("\nFilms in store after returning:");

        storeInventory.listAllNotRentedFilms();
        
        System.out.println("\n----------------------------------------");

        /* Setting Bonus points to 50. */
        ...
        System.out.println("\nShows how much cost renting the film 'Matrix' for 7 days:");
        ...
        System.out.println("\nShows how much customer has to pay for 'Matrix' if he holded the film for 2 extra day:");

        /* Gets the price, if the film is returned late.
            Argument indicates, how many extra days customer rented the film.
         */
        System.out.println("\nExtra charge for bringing the movie late: " + matrix.getPriceOfOneFilmIfLate(2));
    }
